#!/usr/bin/env python3
"""i18n module for ColabMCP CLI - supports English (default) and Chinese.

Usage:
    import i18n
    i18n.t('loading_notebook', name='notebook.ipynb')

Set the language via the COLABMCP_LANG environment variable (e.g. 'zh'),
or at runtime via i18n.set_lang('zh').
"""

import os

# Default language loaded from environment (English unless COLABMCP_LANG=zh)
...
TRANSLATIONS = {
    'en': {
        ...
        'version': 'colabmcp-cli version {version}',
        ...
        # ============ Server side (colab_server.py response messages) ============
    ...
    'zh': {
        ...
        'version': 'colabmcp-cli 版本 {version}',
